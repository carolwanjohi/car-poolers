...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pooler', '0005_auto_20171201_1726'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='DriverProfile',
            fields=[
                ('driver', annoying.fields.AutoOneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='pooler.Driver')),
